 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  toPrint += p1.toString("shp7");

                  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Johntavious Barkley");
		  toPrint += p2.toString("jbarkley3");
		  
                  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Patrick Edenfield");
		  toPrint += p3.toString("pedenfield3");
                  
		  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Clay Washington");
                  toPrint += p4.toString("cwashington34");

                  //Person5 replace P5 with your name
                  //and gburdell5 with your gt id

                  Person5 p5 = new Person5("Hosna Chaudhry");
                  toPrint += p5.toString("hchaudhry3");
